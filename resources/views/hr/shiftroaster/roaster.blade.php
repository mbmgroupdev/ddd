            ...
            <div class="row">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h6>Holiday Roster Assign <a href="{{ url('hr/timeattendance/shift_roaster')}}" target="_blank" class="btn btn-success btn-xx pull-right"> <i class="fa fa-eye"></i> Shift Roster</a> &nbsp; <a href="{{ url('/hr/shift_roaster/roaster_view')}}" target="_blank" class="btn btn-info btn-xx pull-right"> <i class="fa fa-eye"></i> View Holiday Roster</a></h6>
                    </div>
