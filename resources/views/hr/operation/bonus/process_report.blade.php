                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <input type="hidden" name="group-unit" value="{{ $bonusSheet->unit_id}}">
                                    </div>
                                    <div class="col-3">
                                       ...
                                       <div class="modal-content">
                                        <form class="form-horizontal" role="form" action="#" id="auditBonus">
                                          <div class="modal-header">
                                             <h5 class="modal-title" id="exampleModalCenteredScrollableTitle"><strong>{{ date('F, Y', strtotime($bonusSheet->cutoff_date)) }} </strong> Bonus Process</h5>
                                          ...
                                          <div class="modal-body">
                                           ...
                                           <div class="form-group has-float-label">
                                              <input type="text" class="form-control" id="comments" name="comment" placeholder="Type Comments" value="" autocomplete="off" />
                                          ...
                                          <div class="modal-footer">
                                             ...
                                             <button type="button" id="auditBonus" class="btn btn-primary auditbtn">Save & Submit</button>
                                          </div>
                                        </form>
                                       </div>
                                    </div>
  ...
  $(document).ready(function(){   
      ...
      $('#auditBonus').on("click", function(){
        ...
        var status = 0;
          ...
          // console.log(month);
          if(status == 0 && comment == ''){
            $.notify('If Approval Reject then Type Comment', 'error');
          }else if(month == ''){
