		...
		<div class="report_section">
			...
			<div class="top_summery_section">
				...
				<div class="page-header">
		            <h2 style="margin:4px 10px; font-weight: bold; text-align: center;">OT Report </h2>
		            	...
		            	<div class="col-4 no-padding">
		            		<div class="row">
		            			<div class="col-4 pr-0">
		                			<h4 style=""><font style="font-weight: bold; font-size: 12px;">OT Date</font></h4>
		                		</div>
		                		...
		                		@endif
		                		<div class="col-4 pr-0">
		                			<h4><font style="font-weight: bold; font-size: 12px;">Total OT Employee</font></h4>
		                		</div>
		                		<div class="col-8 pl-0">
		                			<b>: {{ $totalEmployees }}</b>
		                		</div>
		                		<div class="col-4 pr-0">
		                			<h4><font style="font-weight: bold; font-size: 12px;">Total OT Hour</font></h4>
		                		</div>
		                		<div class="col-8 pl-0">
		                			<b>: {{ $totalValue }}</b>
		                		</div>
