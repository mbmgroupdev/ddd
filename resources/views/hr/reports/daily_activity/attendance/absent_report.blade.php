		...
		<div class="report_section">
			...
			<div class="top_summery_section">
				...
				<div class="page-header">
		            <h2 style="margin:4px 10px; font-weight: bold; text-align: center;">Absent Report </h2>
		            	...
		            	<div class="col-4 no-padding">
		            		<div class="row">
		                		...
		                		<div class="col-3 pr-0">
		                			<h4 style=""><font style="font-weight: bold; font-size: 12px;">Absent Date</font></h4>
		                		</div>
		                		...
		                		@endif
		                		<div class="col-3 pr-0">
		                			<h4><font style="font-weight: bold; font-size: 12px;">Total Absent</font></h4>
		                		</div>
		                		<div class="col-9 pl-0">
		                			<b>: {{ $totalEmployees }}</b>
		                		</div>
			...
			<div class="content_list_section">
				@if($input['report_format'] == 0)
					...
					<table class="table table-bordered table-hover table-head">
			            ...
			            @else
				            <tr>
				            	<td colspan="9" class="text-center">No Absent Employee Found!</td>
				            </tr>
			            @endif
			            </tbody>
			            <tfoot>
				...
				@elseif(($input['report_format'] == 1 && $format != null))
					...
					<table class="table table-bordered table-hover table-head">
						...
						<tbody>
							...
							@else
							<tr>
				            	<td colspan="3" class="text-center">No Absent Employee Found!</td>
				            </tr>
							@endif
						</tbody>
