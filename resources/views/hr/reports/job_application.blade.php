            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <form class="form-horizontal" role="form" method="post" action="{{ url('hr/reports/job_application') }}" enctype="multipart/form-data"> 
                         ...
                         {{ csrf_field() }} 
                        <div class="col-sm-12 job_app_field no-padding-left" style="margin-bottom: 20px;">
                            <label class="col-sm-2 control-label no-padding-right" for="job_app_id"> Associate's ID <span style="color: red; vertical-align: top;">&#42;</span></label>
                            ...
                            <div class="col-sm-5">
                                 ...
                                 <button type="submit" onclick="printMe('job_application')" title="Print" class="btn btn-warning btn-sm">
