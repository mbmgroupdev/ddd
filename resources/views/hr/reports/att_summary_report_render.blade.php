<div id="PrintArea" >
    <div class="panel">
        <div class="panel-body">
            ...
            <table class="table table-bordered table-hover table-head" width="100%" cellpadding="0" cellspacing="0">
                <tr>
            ...
            <div class=" non_ot_holder_list">
                <table class="table table-bordered table-hover table-head" cellpadding="0" cellspacing="0" border="1" width="100%">
                    <thead>
