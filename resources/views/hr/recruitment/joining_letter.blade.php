                        ...
                        <div class="form-group">
                            ...
                            <div id="printable">
                                <div class="tinyMceLetter" id="letter" style="font-size: 12px;">
                                    ...
                                    <p>কর্তৃপক্ষ অত্যন্ত আনন্দের সহিত জানাচ্ছে যে, আপনাকে নিম্নলিখিত শর্তসাপেক্ষে অত্র কারখানার <b>{{ (!empty($info->hr_designation_name_bn)?$info->hr_designation_name_bn:null) }}</b> পদে প্রতি মাসে সর্বসাকুল্যে মোট {{ (!empty($info->ben_joining_salary)?str_replace($en, $bn, $info->ben_joining_salary):null) }} টাকা বেতনে  গ্রেডঃ <span style="display: inline-block;width: 60px;">{{$info->hr_designation_grade?$info->hr_designation_grade:''}} </span> নিয়োগ দেওয়ার সিদ্ধান্ত গ্রহণ করিয়াছেন, আপনার পরিচয় পত্র নং(আই.ডি. নং)-<b>{{$info->associate_id}}</b>  যাহা <b>{{ (!empty($info->as_doj)?str_replace($en, $bn, $info->as_doj):null) }}</b> তারিখ হইতে কার্যকরী।</p>
                                    ...
                                    <table width="600">
                                        ...
                                        <tr>
                                            ...
                                            <td>: টাকা {{ (!empty($info->food)?str_replace($en, $bn, $info->food):null) }}/=</td>
                                        </tr>
                                        <tr>
                                    ...
                                    <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;ঙ) মাতৃকল্যাণ ছুটিঃ- কোন মহিলা কর্মকর্তা/কর্মচারী যদি অত্র প্রতিষ্ঠানে একাধিক্রমে ০৬(ছয়) মাস চাকুরী করেন তাহলে তিনি উক্ত ছুটি ভোগ করিতে পারিবেন। ২০০৬ সালের মাতৃকল্যাণ আইনের ধারা অনুযায়ী মোট ১৬ সপ্তাহ বা (৫৬+৫৬)=১১২ দিন মাতৃত্বকালীন ছুটি (আইনানুগ ও নগদে) ভোগ করিতে পারিবেন।</p>
                                 ...
                                 টাকা হাজিরা বোনাস প্রদান করা হয়। (ইহা আইনানুনাগ কোন পাওনা নয়। ইহা বেতনের বাহিরের একটি অংশ)</p>
                                    ...
                                    <p>১২। গোপনীয়তা রক্ষার নীতি (Non-Disclosure Policy)ঃ প্রতিষ্ঠানের স্বার্থে সকল প্রকার তথ্য গোপন রাখিতে হইবে।</p>
