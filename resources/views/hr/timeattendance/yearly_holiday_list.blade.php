    ...
    <div class="main-content-inner">
        ...
        <div class="page-content"> 
            ...
            <div class="panel panel-info">
                <div class="panel-heading"><h6>Yearly Holiday List<a href="{{ url('hr/timeattendance/operation/yearly_holidays/create')}}" class="pull-right btn btn-xx btn-info">Yearly Holiday Planner</a></h6></div> 
