						...
						<div class="widget-body">
							<div class="widget-main center" style="min-height:220px;">
								...
								<div class="row no-padding no-margin">
					                <div class="widget-container-col col-sm-12 no-padding-left no-padding-right" id="widget-container-col-4">
					                    <div class="widget-box no-padding no-margin" id="widget-box-4">
					                        <div class="widget-header widget-header-small">
						                        <h5 class="widget-title pull-left" style="padding-left: 8px !important; color: darkgreen !important;">Employee Status Summary</h5>
						                        <div class="widget-toolbar pull-right">
						                            <a href="#" data-action="collapse" style="color: darkgreen;">
					                        ...
					                        <div class="widget-body">
					                        <table class="table table-bordered  table-hover" style="margin:0!important;cursor:pointer; background: wheat !important;">
												<thead>
													<tr>
					            ...
					            <div class="row no-padding no-margin" style="margin-top: 20px !important;">
					                <div class="widget-container-col" id="widget-container-col-4">
					                    <div class="widget-box no-padding no-margin" id="widget-box-5">
					                        <div class="widget-header widget-header-small">
						                        <h5 class="widget-title pull-left" style="padding-left: 8px !important; color: darkgreen !important;">Amounts</h5>
						                        <div class="widget-toolbar pull-right">
						                            <a href="#" data-action="collapse" style="color: darkgreen;">
					                        ...
					                        <div class="widget-body">
												...
												<thead>
						           	        	...
						           	        	@if(!empty(Request::get('month')))
						           	        		{{-- <tr>
						           	        			<th colspan="5" style="color: forestgreen;">Input Month</th>
						           	        		</tr> --}}
						           	        		
						           	        		{{-- <tr>
						           	        			<th colspan="5" style=" color: forestgreen;">Previous Month</th>
						           	        		</tr> --}}
						           	        		@if($salInfo_previous->emp > 0)
						           	        			<tr style="background-color: sandybrown; ">
						           	        				{{-- <td style="text-align: left;">{{$salInfo_previous->emp}}</td> --}}
						           	        		...
						           	        		@if($salInfo_input_month->emp > 0)
						           	        			<tr style="background-color: tomato; ">
						           	        				{{-- <td style="text-align: left;">{{$salInfo_input_month->emp}}</td> --}}
						           	        				<td style="text-align: left;">
						           	        					{{
																	$current_out_emp['active']
																	+$current_out_emp['maternity']
