      ...
      <ul id="iq-sidebar-toggle" class="iq-menu">
         ...
         <li>
            ...
            <ul id="adminstration" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
               <li><a href="{{ url('/hr/adminstrator/user/create') }}"><i class="ri-file-list-fill"></i>Add User</a></li>
               <li><a href="{{ url('/hr/adminstrator/users') }}"><i class="ri-user-add-fill"></i>All User</a></li>
               <li><a href="{{ url('') }}"><i class="ri-user-add-fill"></i>Add Role</a></li>
               <li><a href="{{ url('') }}"><i class="ri-profile-fill"></i>All Role</a></li>
