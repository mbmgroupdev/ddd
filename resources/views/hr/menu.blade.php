@section('nav')
   <nav class="iq-sidebar-menu">
      <ul id="iq-sidebar-toggle" class="iq-menu">
         ...
         <li class="active">
            <a href="{{ url('/hr') }}" class="iq-waves-effect"><i class="ri-home-8-fill"></i><span>HR Dashboard</span></a>
         </li>
         <li>
            <a href="#recruitment" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i class="ri-mail-open-fill"></i><span>Recruitment</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
            <ul id="recruitment" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
               <li><a href="app/index.html"><i class="ri-inbox-fill"></i>New Recruit</a></li>
               <li><a href="app/email-compose.html"><i class="ri-edit-2-fill"></i>Recruit List</a></li>
               <li><a href="app/email-compose.html"><i class="ri-edit-2-fill"></i>Job Application</a></li>
               <li><a href="app/email-compose.html"><i class="ri-edit-2-fill"></i>Appointment Letter</a></li>
               <li><a href="app/email-compose.html"><i class="ri-edit-2-fill"></i>Nominee</a></li>
               <li><a href="app/email-compose.html"><i class="ri-edit-2-fill"></i>Background Verification</a></li>
            </ul>
         </li>
