    ...
    <div class="main-content-inner">
        ...
        <div class="page-content"> 
            ...
            <div class="panel panel-info">
              <div class="panel-heading"><h6>Line</h6></div> 
                ...
                <div class="col-sm-offset-3 col-sm-6">
                    ...
                    <!-- <h1 align="center">Add New Employee</h1> -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="hr_line_name" placeholder="Line Name" class="col-xs-12"  data-validation="required length" data-validation-length="1-128" data-validation-allowing="/ _-"/>
                            </div>
                        </div>
            ...
            <div class="panel panel-info">
              <div class="panel-heading"><h6>Line List</h6></div> 
                <div class="panel-body">
                <div class="col-sm-12">
