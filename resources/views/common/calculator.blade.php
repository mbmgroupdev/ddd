...
@endpush
<div class="calc-main out-of-network">
	...
	<div class="cal-bottom">
		...
		<div class="row">
			<div class="col">
				<div ><button class="btn btn-sm btn-outline-danger w-100 close-cal"> <i class="las la-times"></i> Close</button></div>
			</div>
			<div class="col">
				<div><button class="btn btn-sm btn-outline-success w-100 ok-cal"> <i class="las la-check"></i> OK</button></div>
			</div>
		</div>
