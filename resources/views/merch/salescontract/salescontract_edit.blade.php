          ...
          <div class="page-content">
            ...
            <div class="text-right">
                <div class="col-sm-12">
                   ...
                   {{--  <a href="{{ url('merch/sales_contract/amendment/'.$url['7']) }}" class="btn btn-xs btn-success" data-toggle="tooltip" title="Add Amendment">
                        Add Amendment
                    </a> --}}

                    {{-- <a href="{{ url('merch/sales_contract/amendment/'.$sales->id) }}" class="btn btn-xs btn-success" data-toggle="tooltip" title="Add Amendment">
                        Add Amendment
                    </a> --}}
                                    ...
                                    <div class="row form-group">
                                      ...
                                      <div class="col-xs-6 col-sm-4">
                                          <div class="form-group">
                                              ...
                                              <div class="col-sm-8">
                                                <div class="col-xs-6 col-sm-6 no-padding-right no-padding-left">
                                                 <input type="text" name="initial_value" id="initial value" value="{{$sales->initial_value}}"placeholder="Enter" class=" col-xs-12" style="height: 32px;" />
                                               </div>
