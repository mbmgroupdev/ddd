...
@push('css')
  <style>
    ...
    #new_garments_type .select2{width: 100% !important;}
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    {{ Form::open(["url" => "merch/style/style_copy_store", "class"=>"form-horizontal", "files"=>true]) }}
                                        ...
                                        {{-- hidden field --}}
                                       <input type="hidden" name="stl_order_type" id="inlineRadio1" value="{{ $style->stl_type}}" data-validation="required" readonly>
                                       <input type="hidden" name="style_id" value="{{ $style->stl_id }}">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <div class="row" id="multi-image-div" style="padding:0;">
                                                            <div class="col-sm-2 multi-image ">
                                                                ...
                                                                <input type="hidden" name="stl_img" value="{{ $style->stl_img_link }}">
                                                            </div>
                                                        </div>
                                                        @php $cc = 0; @endphp
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group row">
                                                    <label class="col-sm-4 control-label no-padding-right" for="stl_no" >New Style Reference<span class="color: warning">&#42;</span></label>
                                                    <div class="col-sm-7 col-xs-11">
                                                        <input type="text" id="stl_no" name="stl_no" placeholder="Enter Style No" class="form-control col-xs-12" data-validation="required length custom" data-validation-length="1-30" value="{{ $style->stl_no.'-'.$season[$style->mr_season_se_id] }}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    @hasanyrole("Super Admin|merchandiser")
                                                      <div class="col-sm-1 col-xs-1" style="padding-left: 0px;">
                                                          <button class="addart btn btn-xs" style=" padding-bottom: 5px; padding-right: 0px; padding-left: 1px; display: none;" data-toggle="modal" data-target="#new_garments_type" id="new_garments_type_btn_id" type="button"><i class="glyphicon glyphicon-plus"></i></button>
                                                      </div>
                                                    @endhasanyrole
                                                </div>
                                                <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <!-- Special Machine -->
                                                <div class="form-group row">
                                                    <label class="col-sm-4 control-label no-padding-right" for="stl_no_old" > Style Reference 1<span class="color: warning">&#42;</span></label>
                                                    <div class="col-sm-8 col-xs-11">
                                                        <input type="text" id="stl_no_old" name="stl_no_old" placeholder="Enter Style Reference 1" class="col-xs-12 form-control" data-validation="required length custom" value="{{ $style->stl_no }}" data-validation-length="1-30" readonly="readonly" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
...
$(document).ready(function()
{
  ...
  setTimeout(function() {
    ...
    $('#se_id').on("change", function(){
        ...
        $('#stl_no').val($('#stl_no_old').val()+'-'+$('#se_id option:selected').text());
    });
